...
import { createShortUrl, updateShortUrl, getShortUrl, getCrawImgs } from "../controllers/api_url_controller.js";
import { wrapAsync } from "../middlewares/error_handler.js";
import { softVerifyJWT } from "../middlewares/token.js";

router.route("/url/:url_id").post(upload.single("picture"), softVerifyJWT, wrapAsync(updateShortUrl));
