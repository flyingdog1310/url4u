...
router
  .route("/device_click/:id")
  .get(verifyJWT, wrapAsync(getUrlClickByDevice));
router
  .route("/region_click/:id")
  .get(verifyJWT, wrapAsync(getUrlClickByRegion));
router
  .route("/referrer_click/:id")
  .get(verifyJWT, wrapAsync(getUrlClickByReferrer));
